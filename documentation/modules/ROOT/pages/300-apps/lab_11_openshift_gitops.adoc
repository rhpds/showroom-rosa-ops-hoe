...
+
image::../../assets/images/gitops_operator.png[OpenShift Web Console - OpenShift GitOps in OperatorHub]
...
----
+
image::../../assets/images/argo_app1.png[]

. Click on the Application to show its topology
+
image::../../assets/images/argo_sync.png[]
...
+
image::../../assets/images/bgd_green.png[]
...
+
image::../../assets/images/app_blue.png[]
...
+
image::../../assets/images/sync_bgd.png[]

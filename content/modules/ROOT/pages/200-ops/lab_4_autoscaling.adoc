...
----
ID      AUTOSCALING  REPLICAS  INSTANCE TYPE  LABELS    TAINTS    AVAILABILITY ZONES    SUBNETS    SPOT INSTANCES  DISK SIZE  
worker  Yes          2-4       m5.xlarge                          us-east-2a                       No              300 GiB
----
+
...
----
ID       AUTOSCALING  DESIRED REPLICAS  CURRENT REPLICAS  INSTANCE TYPE  LABELS    TAINTS    AVAILABILITY ZONE  SUBNET                    VERSION  AUTOREPAIR  TUNING CONFIGS  MESSAGE                                        
workers  Yes          2-4               2                 m5.xlarge                          us-east-2a         subnet-05499265505d0c9bd  4.12.36  Yes                         WaitingForAvailableMachines: NodeProvisioning  
----
endif::[]

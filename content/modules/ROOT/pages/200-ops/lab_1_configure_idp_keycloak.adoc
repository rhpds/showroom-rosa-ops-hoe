...
[source,text,options=nowrap]
----
I: Configuring IDP for cluster 'rosa-zwrzl'
I: Identity Provider 'RosaKeycloak' has been created.
   It may take several minutes for this access to become active.
   To add cluster administrators, see 'rosa grant user --help'.

I: Callback URI: https://oauth.rosa-zwrzl.8ffn.p3.openshiftapps.com:443/oauth2callback/RosaKeycloak
I: To log in to the console, open https://console-openshift-console.apps.rosa.rosa-zwrzl.8ffn.p3.openshiftapps.com and click on 'RosaKeycloak'.
----
endif::[]
...
+
[source,sh,role=copy,subs="attributes"]
----
oc login -u rosa-admin -p RosaIsGre@t {rosa_api_url}
----
+
ifeval::["{rosa_deploy_hcp}" == "False"]
.Sample Output

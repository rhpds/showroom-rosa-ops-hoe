...
workers  No           2/2       m5.xlarge                          us-east-2a         subnet-02ee20ca64bb93535  {rosa_version}   Yes
----
endif::[]
...
----
ID       AUTOSCALING  REPLICAS  INSTANCE TYPE  LABELS    TAINTS    AVAILABILITY ZONE  SUBNET                    VERSION  AUTOREPAIR  
workers  No           3/3       m5.xlarge                          us-east-2a         subnet-02ee20ca64bb93535  {rosa_version}   Yes
----
endif::[]
